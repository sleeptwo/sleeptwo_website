...
export const metadata: Metadata = {
  ...
  description:
    "SleepTwo's privacy policy. Learn how we collect, use, and protect your sleep data and personal information.",
  alternates: { canonical: "https://sleeptwo.app/privacy" },
};
        ...
        <div className="max-w-3xl mx-auto px-6 pb-24">
          ...
          >
            <p className="leading-relaxed text-base" style={{ color: "var(--muted)" }}>
              SleepTwo (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;) is committed to protecting
              your privacy. This policy explains what information we collect,
              how we use it, and the choices you have. By using SleepTwo you
          ...
          <Section title="2. How We Use Your Information">
            ...
            <P>
              ...
              your sleep data for advertising purposes.
            </P>
          </Section>

          <Section title="3. How We Store Your Data">
            <P>
              Your sleep and account data is stored in Apple CloudKit — Apple&rsquo;s
              encrypted cloud database. This means your data is subject to
              Apple&rsquo;s privacy and security standards, including end-to-end
              encryption where supported.
            </P>
            <P>
              Subscription and entitlement status is managed by RevenueCat.
            ...
            <P>
              Email verification codes are generated on-device, sent via Brevo&rsquo;s
              transactional email service, and are never stored permanently. They
          ...
          <Section title="4. Data Sharing">
            <P>
              We share limited data only with the service providers needed to
              operate the app:
            </P>
            <UL
              items={[
            ...
            />
            <P>
              Your sleep data is shared with your paired partner within the app
              so that compatibility scores can be computed. You can unpair from
              your partner at any time in Settings, which stops data sharing
              immediately.
            </P>
            <P>
          ...
          <Section title="5. Health Data">
            <P>
              SleepTwo accesses sleep and heart rate data from Apple HealthKit
              solely to provide sleep tracking features within the app. We do
              not share HealthKit data with advertisers, data brokers, or any
              third party not required to operate the service. We do not use
              HealthKit data for marketing.
            </P>
            <P>
              You can revoke HealthKit permissions at any time in your iPhone
              Settings → Health → Apps → SleepTwo.
            </P>
          </Section>
          ...
          <Section title="7. Data Retention">
            <P>
              ...
              delete your account, we delete your personal data from our systems
              within 30 days, except where we are required to retain it by law.
              Sleep data stored in your personal Apple CloudKit container is
              governed by Apple&rsquo;s data retention policies.
            </P>
          </Section>

          <Section title="8. Children's Privacy">
            <P>
              SleepTwo is not intended for users under 17 years of age. We do
          ...
          <Section title="9. Changes to This Policy">
            <P>
              ...
              notify you of material changes via an in-app notification or by
